...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        # Shuffle and take 'batch_size' firsts
        random_idxs = np.random.permutation(len(self.obs))[:batch_size]
        obs_sample = self.obs[random_idxs]
        acs_sample = self.acs[random_idxs]
        rews_sample = self.rews[random_idxs]
        next_obs_sample = self.next_obs[random_idxs]
        terminals_sample = self.terminals[random_idxs]
